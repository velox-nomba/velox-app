...
export default function Navbar() {
  return (
    <header className="absolute top-0 left-0 right-0 z-10">
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-6 py-5 mt-[18px]">
        ...
        <div
          className={`${styles.navText} hidden items-center gap-8 text-sm text-white md:flex`}
        >
          <Link href="#" className={`${styles.home} hover:text-white/80`}>
            Home
          </Link>
